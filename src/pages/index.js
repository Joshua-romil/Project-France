...
const IndexPage = () => (
  <div>
    ...
    <div className="Cards"></div>
      <h2>5 Services</h2>
      <Card title="Social Media Marketing for anyone" text="Try 1 month for 50% off" image={require('../images/wallpaper.jpg')}/>
  </div>
)
